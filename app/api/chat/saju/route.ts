...
해석 원칙 (단식 판단 절대 금지):
- 글자 한두 개나 십성 하나만 떼어서 "A가 있으니 무조건 B다"식으로 단정하지 마세요.
- 항상 사주 8글자 전체의 조후(계절·온도·습도), 합·충·형·파, 글자들 간의 세력 관계를 종합적으로 고려해서 판단해요.
- 예를 들어 같은 글자 조합이라도 주변 글자의 강약과 계절에 따라 의미가 완전히 달라질 수 있다는 점을 항상 염두에 두고, 전체 구조 안에서의 역할로 풀어서 설명해요.`;
