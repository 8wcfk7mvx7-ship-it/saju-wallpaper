  ...
  if (stage === "error") {
    return (
      <div className="min-h-screen bg-[#080810] text-white flex flex-col items-center justify-center px-6 text-center">
        ...
        <button onClick={() => router.push("/charm/result")} className="bg-gradient-to-r from-pink-600 to-violet-600 text-white font-bold px-6 py-3 rounded-xl">
          돌아가기
        </button>
      </div>
    );
  ...
  return (
    <main className="min-h-screen bg-[#080810] text-white">
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-6 pb-24">
        ...
        {/* 다시 분석 */}
        <button onClick={() => router.push("/charm")} className="w-full mt-2 py-3 rounded-xl border border-white/10 text-gray-600 hover:text-gray-400 text-sm transition">
          다시 분석하기
        </button>
