...
const SINSALS = [
  ...
  {
    name: "의처살(疑妻殺)·의부살(疑夫殺)",
    icon: "💔",
    color: "#fda4af",
    summary: "배우자에게 집착하고 내심 의심하게 되는 일주의 기운",
    desc: "출생일(일주) 기준으로 판단하는 신살입니다. 일지 지장간이 정재(남자) 또는 정관(여자)과 암합을 이루는 갑오·병술·무진·경진·임술(남, 의처살), 을사·정해·기해·신사·계해(여, 의부살) 일주가 해당합니다. 배우자를 깊이 아끼는 만큼 그 애착이 의심과 집착으로 이어지기 쉬운 구조입니다.",
    positive: "배우자에 대한 깊은 애정과 충실함, 가정을 지키려는 강한 책임감",
    caution: "근거 없는 의심이 반복되면 관계를 갉아먹습니다. 불안의 뿌리가 상대가 아니라 자신의 내면에 있다는 걸 인지하고, 신뢰를 언어로 확인하는 습관을 들이는 것이 중요합니다.",
  },
];
