...
const SERVICES: {
  ...
  {
    id: "hunnyeo", emoji: "📕",
    title: "훈녀생정 — 문방구 500원짜리 책",
    viral: "밀가루팩, 봉숭아물, 덴마크 다이어트... 그 시절 소책자를 그대로 펼쳤습니다",
    desc: "누런 갱지에 2도 인쇄된 문방구 소책자 감성 그대로. 제1장 얼굴팩부터 봉숭아물 들이기, 다이어트, 머릿결·발·손톱 관리까지 — 해 본 것에 확인 도장을 찍으면 '나의 훈녀력'이 쌓입니다.",
    tags: ["500원", "레트로", "완소"],
    href: "/hunnyeo", badge: "NEW",
    color: "#ff6fa5", badgeBg: "rgba(219,39,119,0.85)",
    border: "rgba(255,111,165,0.3)", glow: "rgba(255,111,165,0.12)",
    categories: ["전체", "무료", "라이프"],
  },
];
