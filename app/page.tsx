...
const SERVICES: {
  ...
  {
    id: "hunnyeo", emoji: "🎀",
    title: "훈녀생정 — 90년대생 추억 뷰티 다이어리",
    viral: "밀가루팩, 봉숭아물, 덴마크 다이어트... 그 시절 완소 정보 다시 꺼내봤어요",
    desc: "밀가루팩부터 수박당·덴마크 다이어트, 머릿결·발·손톱 관리법, 봉숭아물 들이기, 완소템까지. 따라 한 만큼 '나의 훈녀력'이 쌓이는 90년대생 추억 뷰티 앱.",
    tags: ["완소", "레트로", "추억템"],
