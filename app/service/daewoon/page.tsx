...
const UUNSEONG_FORTUNE: Record<string, { label: string; score: number; color: string; desc: string; narrative: string; caution: string; keyword: string }> = {
  ...
  제왕: {
    ...
    desc:"에너지가 최고조에 달한 왕의 시기. 그러나 정점 이후엔 내리막이 시작돼.",
  ...
  쇠: {
    ...
    desc:"에너지가 꺾이기 시작하는 시기. 무리보다 내실을 다져야 해.",
  ...
  병: {
    ...
    desc:"몸과 마음이 본격적으로 지치는 시기. 과욕을 버리고 쉬어야 해.",
  ...
  사: {
    ...
    narrative:"사는 죽음이 아니라 에너지가 완전히 정지한 상태다. 이 시기엔 아무리 노력해도 결과가 나오지 않는 느낌이 강하다. 생각은 많은데 실행으로 이어지지 않고, 주변에서는 답답해 보일 수 있어. 어린 나이에 이 대운이 오면 또래보다 생각이 깊고 '애늙은이' 소리를 듣거나, 몸이 약해 활발하게 뛰어놀지 못하는 시기를 보낼 수 있어. 이 정체의 시간이 사실은 다음 절·태·양으로 넘어가기 위한 충전의 기간이다.",
    caution:"이 시기의 성과 없음을 자신의 무능으로 오해하지 말아야 해. 억지로 뚫으려 할수록 더 막힌다. 멈춤을 받아들이는 것이 최선이다.",
    keyword:"정지 · 애늙은이 · 체력저하 · 충전 · 인내"
  },
  묘: {
    label:"묘(墓)", score:1, color:"#dc2626",
    desc:"무덤에 갇힌 형국. 활동 반경이 좁고 정신적 답답함이 극에 달해.",
    narrative:"묘는 무덤이다. 외부 활동이 제한되고 심리적으로 굉장히 갇힌 느낌이 드는 구간이다. 하고 싶은 것은 많은데 현실의 벽이 너무 두껍게 느껴지고, 노력해도 제자리인 것 같아 무기력과 우울감이 찾아올 수 있어. 특히 사춘기에 이 대운이 겹치면 억압받는다는 느낌, 부모·환경에 대한 답답함이 매우 강하게 나타나. 이 시기는 외부 확장보다 내면의 공부, 명상, 자기 탐구에 집중하는 것이 훨씬 유리하다.",
    caution:"충동적 탈출을 시도하면 오히려 더 깊이 갇힌다. 지금 닦는 내면의 깊이가 이후의 자산이 돼.",
    keyword:"폐쇄 · 억압감 · 우울 · 내면탐구 · 답답함"
  },
  절: {
    label:"절(絶)", score:2, color:"#9333ea",
    desc:"모든 기반이 끊어지고 리셋되는 시기. 고독과 단절이 운명처럼 찾아와.",
  ...
  태: {
    ...
    narrative:"어머니 뱃속에 씨앗이 막 자리를 잡은 상태다. 아직 세상에 드러나지 않았지만 내부에서 새로운 것이 조용히 형성되고 있는 구간이다. 이 시기엔 외부 성과보다 내면에서 새로운 아이디어, 방향, 목표가 싹트기 시작해. 지금 당장 결과가 보이지 않아 조급할 수 있지만, 이 잉태의 시간이 충분히 무르익어야 이후 양·장생 대운에서 폭발적인 성장이 가능하다.",
  ...
  양: {
    ...
    narrative:"뱃속에서 태아가 세상에 나올 준비를 하는 구간이다. 태 대운에서 잉태된 씨앗이 이제 구체적인 형태를 갖춰가기 시작해. 아직 세상에 화려하게 등장하진 않지만 꾸준히 공부하고 실력을 쌓으면 그것이 그대로 다음 장생 대운의 도약대가 돼. 주변에서 인정을 많이 받지 못해도 지금 하는 노력이 반드시 의미 있다는 확신을 가져도 좋다.",
...
const SIPSEONG_DAEWOON: Record<string, { title: string; color: string; desc: string; life: string; caution: string }> = {
  비견: {
    ...
    life:"경쟁이 많아지는 시기다. 형제·친구·동료와의 갈등 혹은 연대가 동시에 일어나. 사업가라면 동업이나 경쟁자 출현, 직장인이라면 같은 라인의 동료들과 경쟁이 심화돼. 재물을 분산시키는 힘도 있어 재물복보다 관계복이 먼저 와.",
    caution:"고집과 아집이 강해져 주변과의 마찰이 잦아질 수 있어. 독불장군 행세를 경계해야 해."
  },
  겁재: {
    title:"겁재(劫財) 대운", color:"#f87171",
    desc:"빼앗는 기운이 강한 대운. 재물이 나갈 일이 생기고 인간관계에서 배신이나 손해가 발생하기 쉽다.",
    life:"겁재는 나의 재물과 관계를 빼앗아 가는 기운이다. 이 대운에는 예상치 못한 지출, 사기·배신·투자 손실이 발생하기 쉽다. 반면 기존의 잘못된 관계나 미련이 강제로 청소되는 효과도 있어. 운동, 경쟁 분야, 군인·경찰처럼 강한 의지가 필요한 분야에서는 오히려 유리하게 작용해.",
    caution:"이 시기에 투자·보증·동업은 각별히 주의. 재물이 새어나가는 경로를 미리 차단해야 해."
  },
  식신: {
    title:"식신(食神) 대운", color:"#60a5fa",
    desc:"내가 표현하고 먹고 즐기는 기운이 극대화되는 대운. 창의력과 여유가 넘치는 시기.",
    life:"식신 대운에는 먹고 사는 것, 즉 의식주와 관련된 복이 들어와. 요리·예술·콘텐츠·교육처럼 무언가를 만들어 내는 활동들이 빛을 발해. 이 시기에는 지나치게 애쓰지 않아도 자연스럽게 살이 붙듯 복이 따라와. 성격이 온화해지고 인간관계도 원만해지며 주변 사람들이 편하게 여긴다.",
    caution:"너무 편안한 나머지 안주하거나 게을러질 수 있어. 관성(직장·남편운)을 제압하는 기운도 있어 여성이라면 남편과의 갈등 혹은 남편이 힘을 잃는 상황이 생길 수 있어."
  },
  상관: {
    title:"상관(傷官) 대운", color:"#fb923c",
    desc:"관성을 상하게 하는 기운. 직장·규범·권위에 반발하는 시기. 창의적이지만 파란이 많다.",
    life:"상관 대운은 기존의 질서와 권위에 강하게 반발하는 시기다. 직장을 그만두거나 규칙을 깨뜨리고 싶은 충동이 강해진다. 반면 이 에너지를 예술·창작·혁신 쪽으로 쓰면 탁월한 결과물이 나와. 언어 능력이 강해져 말이나 글로 인정받기도 하지만, 말 실수나 구설수가 함께 오기도 해.",
    caution:"여성이라면 이 시기에 남편운이 약해지거나 이별·이혼이 발생하기 쉽다. 직장인은 충동적인 사직을 경계해야 해."
  },
  편재: {
  ...
  정재: {
    ...
    desc:"성실하게 쌓이는 재물의 대운. 꾸준한 노력이 착실한 자산으로 변환돼.",
    life:"정재는 월급·이자·임대수입처럼 안정적이고 예측 가능한 재물이다. 이 대운에는 투기보다 성실한 노동의 대가가 제대로 돌아와. 절약과 저축이 잘 되고, 재산이 착실하게 불어나는 시기다. 남성이라면 좋은 배우자를 만날 가능성이 높은 대운이기도 하다.",
    caution:"너무 안정 지향적이 되어 큰 도전을 놓칠 수 있어. 재물에 대한 지나친 집착이 관계를 망치기도 해."
  },
  편관: {
    title:"편관(偏官) 대운 — 칠살(七殺)", color:"#c084fc",
    desc:"강한 외부 압박과 통제가 들어오는 대운. 극복하면 성공, 못하면 큰 고통.",
    life:"편관, 즉 칠살 대운은 사주에서 가장 강렬한 기운 중 하나다. 외부에서 강한 압박·통제·경쟁이 몰려오는 시기로, 이 압력을 견뎌내면 오히려 강해지지만 버티지 못하면 크게 무너진다. 군인·경찰·정치·스포츠처럼 강한 경쟁 분야에서는 오히려 성공하기 좋은 기운이다. 여성이라면 강하고 카리스마 있는 남성과의 인연이 오기도 해.",
    caution:"무리한 일처리, 사고, 법적 문제가 생기기 쉽다. 스스로를 너무 몰아붙이지 않도록 주의해야 해."
  },
  정관: {
    ...
    caution:"명예를 지키기 위해 지나치게 눈치를 보거나 자기 생각을 억누르는 경향이 생길 수 있어."
  },
  편인: {
    title:"편인(偏印) 대운 — 효신(梟神)", color:"#94a3b8",
    desc:"불규칙하고 신비로운 배움의 대운. 직관과 영감이 강해지지만 불안정하다.",
    life:"편인 대운에는 종교·철학·신비학·예술처럼 비주류적이고 깊은 학문에 빠져들기 쉽다. 직관력과 통찰력이 강해지고 남다른 아이디어가 떠오른다. 반면 현실적인 활동 능력이 약해져 먹고 사는 문제에 소홀해질 수 있어. 식신을 극하는 성질이 있어 건강과 식복(食福)이 약해지기도 해.",
  ...
  정인: {
    ...
    life:"정인 대운은 학업·자격증·논문·공부처럼 배움과 관련된 모든 활동이 빛을 발하는 시기다. 어머니나 선배·스승·기관으로부터 도움을 받기 쉽고, 심리적으로 안정감이 있어. 이 대운에 시험을 보거나 자격을 취득하면 좋은 결과가 나와. 명예롭고 인정받는 방식으로 살고 싶은 욕구가 강해진다.",
    caution:"지나치게 의존적이 되거나 독립심이 약해질 수 있어. 새로운 도전보다 안전함만 추구하면 성장이 멈춘다."
  },
};
...
const SIPSEONG_GENDER_DETAIL: Record<"비겁" | "식상" | "재성" | "관성" | "인성", GenderDomain[]> = {
  비겁: [
    { domain: "직업운", icon: "💼",
      male: "독립·창업·동업 이슈가 부각되는 시기야. 내 이름을 걸고 일하고 싶은 욕구가 커지고, 조직보다 스스로 판을 짜는 쪽이 유리해져. 다만 동료·경쟁자와의 마찰도 함께 늘어나.",
      female: "주체적으로 일을 끌고 가려는 의지가 강해져. 직장 내 라인 경쟁이나 동료와의 신경전이 생기기 쉽고, 본인 사업·프리랜서 전환을 고민하게 되는 흐름도 자주 나타나." },
    { domain: "재물운", icon: "💰",
      male: "형제·동업자·지인과 돈이 얽히는 일이 늘어. 함께 벌 수도 있지만 분산되거나 빠져나가는 쪽으로도 작용하니, 동업·보증은 신중해야 해.",
      female: "내 손으로 직접 벌어들이는 재물에 대한 의욕이 커지는 시기야. 다만 지출도 함께 늘어나는 경향이 있어 씀씀이 관리가 관건이야." },
    { domain: "애정·배우자운", icon: "💑",
      male: "배우자나 연인보다 친구·동료 관계에 에너지가 쏠리기 쉬워. 관계에서 주도권 다툼이 생기면 거리가 멀어질 수 있으니 균형이 필요해.",
      female: "내 주장이 강해지는 시기라 연인·배우자와 기 싸움이 생기기 쉬워. 서로 한 발씩 양보하는 노력이 관계를 지켜줘." },
    { domain: "자녀운", icon: "👶",
      male: "자녀보다 본인의 사회적 입지·경쟁에 신경이 쏠리는 시기야. 자녀와 보내는 시간을 의식적으로 늘리면 좋아.",
      female: "자녀가 독립적이고 고집 센 모습을 보일 수 있는 시기야. 통제하기보다 대화로 이끄는 편이 잘 맞아요." },
  ],
  식상: [
    { domain: "직업운", icon: "💼",
      male: "표현력과 아이디어가 빛을 발하는 시기야. 기획·창작·교육·서비스 분야에서 두각을 나타내기 좋고, 조직보다 자기 색깔을 살리는 일이 잘 맞아요.",
      female: "재능과 끼가 자연스럽게 드러나는 시기야. 콘텐츠·예술·상담·교육 등 자기 표현이 곧 일이 되는 분야에서 성과가 나기 쉬워. 다만 직장 내 권위와는 마찰이 생길 수 있어." },
    { domain: "재물운", icon: "💰",
      male: "내가 만들어낸 결과물이 곧 수입으로 연결되는 흐름이야. 의식주·먹고사는 복이 자연스럽게 따라오는 시기야.",
      female: "능력과 활동을 통해 스스로 돈을 만들어내는 힘이 강해져. 부업·창작 활동·사업 확장에 좋은 시기야." },
    { domain: "애정·배우자운", icon: "💑",
      male: "표현이 풍부해지고 매력이 살아나 이성에게 어필하는 힘이 커져. 다만 자유로움을 추구하다 보니 한 사람에게 집중하기 어려울 수 있어.",
      female: "이 시기는 배우자운(관성)을 누르는 기운이 강해지는 때라, 배우자와의 관계에서 갈등이 불거지거나 거리가 생기기 쉬워. 표현을 다듬는 노력이 관계를 지켜줘." },
    { domain: "자녀운", icon: "👶",
      male: "자녀와의 관계에서 자유롭고 친구 같은 분위기가 형성돼. 자녀의 재능을 발견하고 키워주기 좋은 시기야.",
      female: "여성에게 식상은 자녀를 직접 상징하는 기운이야. 임신·출산·자녀와 관련된 변화가 이 시기에 일어날 가능성이 높고, 자녀와의 정서적 교감도 깊어져." },
  ],
  재성: [
    { domain: "직업운", icon: "💼",
      male: "성과와 결과로 인정받는 시기야. 영업·사업·재무·투자처럼 돈의 흐름을 다루는 분야에서 능력을 발휘하기 좋아.",
      female: "현실 감각과 실무 능력이 빛을 발하는 시기야. 재무·기획·사업 영역에서 인정받기 좋고, 직접 돈을 굴리는 역할을 맡게 될 가능성도 커져." },
    { domain: "재물운", icon: "💰",
      male: "이 시기 전체를 통틀어 재물운이 가장 직접적으로 들어오는 기운이야. 정재면 꾸준한 수입과 자산 형성, 편재면 투자·사업·예상 밖의 수입으로 흐름이 갈려요.",
      female: "스스로 일군 재물이 쌓이기 좋은 시기야. 다만 씀씀이와 관리의 균형이 중요하고, 시댁·부모님과 관련된 경제적 이슈가 함께 따라올 수 있어." },
    { domain: "애정·배우자운", icon: "💑",
      male: "재성은 남자에게 곧 여자(아내·연인)를 상징하는 기운이야. 이성과의 인연이 활발해지고, 정재면 좋은 배우자를 만나거나 결혼으로 이어지기 좋은 시기야. 편재라면 다양한 인연이 스쳐가는 흐름이 될 수 있어.",
      female: "본인의 활동력과 매력이 커지면서 이성에게 어필하는 힘도 함께 강해지는 시기야. 다만 일이 바빠지며 관계에 쏟는 에너지는 상대적으로 줄어들 수 있어." },
    { domain: "자녀운", icon: "👶",
      male: "재성은 자녀(특히 부친 입장에서 자식)를 부양하고 책임지는 힘과 연결돼. 경제적으로 자녀를 든든히 뒷받침할 수 있는 시기야.",
      female: "자녀보다 본인의 활동·성과에 무게가 실리는 시기야. 일과 육아 사이의 균형 잡기가 화두가 될 수 있어." },
  ],
  관성: [
    { domain: "직업운", icon: "💼",
      male: "조직·사회에서의 위치, 승진·평가와 직결되는 핵심 운이야. 정관이면 안정적인 인정과 승진, 편관(칠살)이면 강한 압박 속에서 성과를 내야 하는 경쟁적인 흐름이 강해져.",
      female: "사회적 평가와 직장 내 입지가 뚜렷하게 좌우되는 시기야. 정관이면 신뢰받고 안정적으로 자리를 잡고, 편관이면 책임이 무거워지고 경쟁이 치열한 환경에 놓이기 쉬워." },
    { domain: "재물운", icon: "💰",
      male: "재물 자체보다 사회적 지위·평판이 우선시되는 시기야. 명예가 오르면 자연스럽게 기회와 수입도 따라오는 구조야.",
      female: "직접적인 재물보다 직장·조직을 통한 안정적 기반이 우선시돼. 명예와 신뢰가 곧 기회로 연결돼." },
    { domain: "애정·배우자운(이성운)", icon: "💑",
      male: "관성은 남자에게 자기 자신을 통제하는 기운이라, 연애보다 사회적 책임·역할에 무게가 실려요. 본인을 다스리는 절제력이 관계에도 긍정적으로 작용해.",
      female: "여성에게 관성은 곧 남자(배우자·연인)를 상징하는 기운이야. 정관이면 안정적이고 책임감 있는 사람과 인연이 닿아 결혼으로 이어지기 좋고, 편관(칠살)이면 카리스마 있고 강한 사람과 강렬하게 끌리는 인연이 들어오기 쉬워. 다만 그 끌림 뒤에 갈등도 함께 따라올 수 있어." },
    { domain: "자녀운", icon: "👶",
      male: "남성에게 관성은 자녀(특히 아들)를 상징하는 기운 중 하나야. 자녀와 관련된 책임·역할이 부각되고, 자녀의 사회 진출·성장과 관련된 소식이 들려오기 좋은 시기야.",
      female: "여성에게 관성은 자녀(특히 딸)와도 연결되는 기운이야. 임신·출산 소식이나 자녀의 진학·진로 같은 변화가 이 시기에 맞물려 나타나기 쉬워." },
  ],
  인성: [
    { domain: "직업운", icon: "💼",
      male: "공부·자격·연구·문서와 관련된 일에서 빛을 보는 시기야. 조직보다 전문성으로 인정받는 흐름이 강해지고, 윗사람·기관의 후원을 받기 좋아.",
      female: "배움과 자격이 곧 커리어의 발판이 되는 시기야. 교육·연구·전문직 분야에서 성장하기 좋고, 멘토나 기관의 도움을 받을 가능성이 커." },
    { domain: "재물운", icon: "💰",
      male: "직접 버는 재물보다 명예·자격·문서를 통한 간접적인 이득이 들어오는 시기야. 부모·기관으로부터의 지원도 기대할 수 있어.",
      female: "안정적인 지원과 후원이 따르는 시기야. 다만 직접 활동을 통한 수입(식상·재성)은 상대적으로 약해질 수 있어." },
    { domain: "애정·배우자운", icon: "💑",
      male: "관계보다 자기 내면의 성장, 배움에 더 끌리는 시기야. 다소 신중하고 조심스러운 태도가 관계의 속도를 늦출 수 있어.",
      female: "안정감과 신뢰를 우선시하게 되는 시기야. 어머니·집안 어른의 의견이 인연 선택에 영향을 주는 경우도 많아." },
    { domain: "자녀운", icon: "👶",
      male: "자녀의 교육·학업에 마음이 많이 쓰이는 시기야. 자녀에게 든든한 정신적 지원자가 되어주기 좋아.",
      female: "인성은 여성에게 자녀를 보살피고 품는 기운과도 연결돼. 자녀의 학업·성장을 챙기는 데 마음과 시간이 많이 쓰이는 시기야." },
  ],
};
  ...
  async function analyze() {
    ...
    if (calendarType === "lunar") {
      try {
        ...
        alert("음력 날짜를 양력으로 변환할 수 없어. 날짜를 다시 확인해줘.");
        return;
      }
    }
    try {
