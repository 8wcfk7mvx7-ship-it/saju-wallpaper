...
const SIPSEONG_DAEWOON: Record<string, { title: string; color: string; desc: string; life: string; caution: string }> = {
  ...
  겁재: {
    ...
    life:"겁재는 나의 재물과 관계를 빼앗아 가는 기운이다. 이 대운에는 예상치 못한 지출, 사기·배신·투자 손실이 발생하기 쉽다. 반면 기존의 잘못된 관계나 미련이 강제로 청소되는 효과도 있어요. 운동, 경쟁 분야, 군인·경찰처럼 강한 의지가 필요한 분야에서는 오히려 유리하게 작용해요.",
  ...
  식신: {
    ...
    life:"식신 대운에는 먹고 사는 것, 즉 의식주와 관련된 복이 들어와요. 요리·예술·콘텐츠·교육처럼 무언가를 만들어 내는 활동들이 빛을 발해요. 이 시기에는 지나치게 애쓰지 않아도 자연스럽게 살이 붙듯 복이 따라와요. 성격이 온화해지고 인간관계도 원만해지며 주변 사람들이 편하게 여긴다.",
    caution:"너무 편안한 나머지 안주하거나 게을러질 수 있어요. 관성(직장·남편운)을 제압하는 기운도 있어 여성이라면 남편과의 갈등 혹은 남편이 힘을 잃는 상황이 생길 수 있어요."
  },
  상관: {
    title:"상관(傷官) 대운", color:"#fb923c",
    desc:"관성을 상하게 하는 기운. 직장·규범·권위에 반발하는 시기. 창의적이지만 파란이 많다.",
    life:"상관 대운은 기존의 질서와 권위에 강하게 반발하는 시기다. 직장을 그만두거나 규칙을 깨뜨리고 싶은 충동이 강해진다. 반면 이 에너지를 예술·창작·혁신 쪽으로 쓰면 탁월한 결과물이 나와요. 언어 능력이 강해져 말이나 글로 인정받기도 하지만, 말 실수나 구설수가 함께 오기도 해요.",
  ...
  정재: {
    ...
    life:"정재는 월급·이자·임대수입처럼 안정적이고 예측 가능한 재물이다. 이 대운에는 투기보다 성실한 노동의 대가가 제대로 돌아와요. 절약과 저축이 잘 되고, 재산이 착실하게 불어나는 시기다. 남성이라면 좋은 배우자를 만날 가능성이 높은 대운이기도 하다.",
  ...
  편관: {
    ...
    life:"편관, 즉 칠살 대운은 사주에서 가장 강렬한 기운 중 하나다. 외부에서 강한 압박·통제·경쟁이 몰려오는 시기로, 이 압력을 견뎌내면 오히려 강해지지만 버티지 못하면 크게 무너진다. 군인·경찰·정치·스포츠처럼 강한 경쟁 분야에서는 오히려 성공하기 좋은 기운이다. 여성이라면 강하고 카리스마 있는 남성과의 인연이 오기도 해요.",
  ...
  편인: {
    ...
    life:"편인 대운에는 종교·철학·신비학·예술처럼 비주류적이고 깊은 학문에 빠져들기 쉽다. 직관력과 통찰력이 강해지고 남다른 아이디어가 떠오른다. 반면 현실적인 활동 능력이 약해져 먹고 사는 문제에 소홀해질 수 있어요. 식신을 극하는 성질이 있어 건강과 식복(食福)이 약해지기도 해요.",
  ...
  정인: {
    ...
    life:"정인 대운은 학업·자격증·논문·공부처럼 배움과 관련된 모든 활동이 빛을 발하는 시기다. 어머니나 선배·스승·기관으로부터 도움을 받기 쉽고, 심리적으로 안정감이 있어요. 이 대운에 시험을 보거나 자격을 취득하면 좋은 결과가 나와요. 명예롭고 인정받는 방식으로 살고 싶은 욕구가 강해진다.",
