...
const UUNSEONG_FORTUNE: Record<string, { label: string; score: number; color: string; desc: string; narrative: string; caution: string; keyword: string }> = {
  ...
  목욕: {
    ...
    narrative:"목욕이란 글자 그대로 옷을 다 벗고 알몸이 되는 것이다. 자기의 날것이 그대로 드러나는 구간이라, 이성에 대한 끌림이 강해지고 감각적인 즐거움을 좇게 돼. 예술·음악·이성·술·유흥 등 감각을 자극하는 것들에 집착이 생기기 쉽고, 도화기운이 강해져 이성 관계가 복잡해지는 경우가 많다. 반면 이 에너지를 창작이나 예술 방향으로 틀면 뛰어난 결과물이 나오기도 해.",
  ...
  관대: {
    ...
    narrative:"사회에 처음 나서면서 이름을 알리고 능력을 인정받기 시작하는 구간이다. 학업·자격증·진학·취업처럼 사회적 기반을 쌓는 활동들이 잘 풀리고, 주변에서 기대를 걸기 시작해. 아직 완성형은 아니지만 성장하고 있다는 확신이 있어 흔들리지 않는다. 스승이나 멘토를 만날 가능성도 높고, 이때 쌓은 실력이 이후 건록·제왕 대운의 성공을 결정짓는다.",
    caution:"배우는 것에 집중해야 할 때를 빨리 치고 나가려는 조급함을 경계해야 해.",
