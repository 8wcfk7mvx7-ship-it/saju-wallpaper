...
const UUNSEONG_FORTUNE: Record<string, { label: string; score: number; color: string; desc: string; narrative: string; caution: string; keyword: string }> = {
  ...
  제왕: {
    ...
    narrative:"제왕은 말 그대로 왕의 기운이다. 자기 분야에서 정점에 서게 되고, 타인을 이끌고 지배하는 위치가 돼. 카리스마가 넘쳐 사람들이 자연스럽게 따르고, 원하는 것을 밀어붙이면 이뤄지는 쾌감이 있어. 그러나 정점이기 때문에 이 뒤엔 쇠의 시기가 온다는 것을 알아야 해. 오만해지거나 무리하게 확장하면 이 시기의 성과가 한 번에 무너지는 경우도 있어.",
    caution:"정점에서의 방심이 가장 위험하다. 지금이 영원하지 않음을 인식하고 이 시기에 버퍼를 만들어야 해. 독선적 결정이 관계를 파괴하기 쉽다.",
    keyword:"정점 · 카리스마 · 지배 · 최강 · 오만 경계"
  },
  쇠: {
    label:"쇠(衰)", score:5, color:"#94a3b8",
    desc:"에너지가 꺾이기 시작하는 시기. 무리보다 내실을 다져야 해.",
    narrative:"제왕에서 지나온 절정 이후 몸과 마음이 슬슬 지치기 시작하는 구간이다. 예전만큼 추진력이 나오지 않고, 해왔던 방식이 통하지 않는다는 느낌이 와. 이 시기는 무언가를 새로 벌이기보다 지금까지 쌓아온 것을 정리하고 내실화하는 데 집중해야 해. 건강 신호가 미미하게 오기 시작할 수 있으니 생활 습관을 점검하는 게 좋다.",
    caution:"억지로 기운을 회복하려다 더 소모돼. 조용히 재정비하는 것이 다음 대운을 위한 준비다.",
    keyword:"정리 · 내실 · 하강 시작 · 재정비 · 건강신호"
  },
  병: {
    label:"병(病)", score:3, color:"#fb923c",
    desc:"몸과 마음이 본격적으로 지치는 시기. 과욕을 버리고 쉬어야 해.",
    narrative:"병이라는 글자처럼 기운이 아프다. 체력이 눈에 띄게 떨어지고, 의욕이 줄어들며, 해온 일이 잘 안 풀리거나 장애물이 생기기 시작해. 인간관계에서도 오해나 다툼이 생기기 쉽고, 정서적으로 불안정해지기 쉬운 구간이다. 이때 억지로 욕심을 내면 건강이 무너지거나 큰 손실이 생긴다. 병 대운의 사람들 중 이 시기를 담담하게 버텨낸 사람이 이후 반등이 더 컸다.",
