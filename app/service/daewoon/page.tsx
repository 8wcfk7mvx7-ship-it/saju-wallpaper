...
const UUNSEONG_FORTUNE: Record<string, { label: string; score: number; color: string; desc: string; narrative: string; caution: string; keyword: string }> = {
  ...
  사: {
    ...
    narrative:"사는 죽음이 아니라 에너지가 완전히 정지한 상태다. 이 시기엔 아무리 노력해도 결과가 나오지 않는 느낌이 강하다. 생각은 많은데 실행으로 이어지지 않고, 주변에서는 답답해 보일 수 있어요. 어린 나이에 이 대운이 오면 또래보다 생각이 깊고 '애늙은이' 소리를 듣거나, 몸이 약해 활발하게 뛰어놀지 못하는 시기를 보낼 수 있어요. 이 정체의 시간이 사실은 다음 절·태·양으로 넘어가기 위한 충전의 기간이다.",
    caution:"이 시기의 성과 없음을 자신의 무능으로 오해하지 말아야 해요. 억지로 뚫으려 할수록 더 막힌다. 멈춤을 받아들이는 것이 최선이다.",
    keyword:"정지 · 애늙은이 · 체력저하 · 충전 · 인내"
  },
  묘: {
    label:"묘(墓)", score:1, color:"#dc2626",
    desc:"무덤에 갇힌 형국. 활동 반경이 좁고 정신적 답답함이 극에 달해요.",
    narrative:"묘는 무덤이다. 외부 활동이 제한되고 심리적으로 굉장히 갇힌 느낌이 드는 구간이다. 하고 싶은 것은 많은데 현실의 벽이 너무 두껍게 느껴지고, 노력해도 제자리인 것 같아 무기력과 우울감이 찾아올 수 있어요. 특히 사춘기에 이 대운이 겹치면 억압받는다는 느낌, 부모·환경에 대한 답답함이 매우 강하게 나타나요. 이 시기는 외부 확장보다 내면의 공부, 명상, 자기 탐구에 집중하는 것이 훨씬 유리하다.",
    caution:"충동적 탈출을 시도하면 오히려 더 깊이 갇힌다. 지금 닦는 내면의 깊이가 이후의 자산이 돼요.",
  ...
  태: {
    ...
    narrative:"어머니 뱃속에 씨앗이 막 자리를 잡은 상태다. 아직 세상에 드러나지 않았지만 내부에서 새로운 것이 조용히 형성되고 있는 구간이다. 이 시기엔 외부 성과보다 내면에서 새로운 아이디어, 방향, 목표가 싹트기 시작해요. 지금 당장 결과가 보이지 않아 조급할 수 있지만, 이 잉태의 시간이 충분히 무르익어야 이후 양·장생 대운에서 폭발적인 성장이 가능하다.",
  ...
  양: {
    ...
    narrative:"뱃속에서 태아가 세상에 나올 준비를 하는 구간이다. 태 대운에서 잉태된 씨앗이 이제 구체적인 형태를 갖춰가기 시작해요. 아직 세상에 화려하게 등장하진 않지만 꾸준히 공부하고 실력을 쌓으면 그것이 그대로 다음 장생 대운의 도약대가 돼요. 주변에서 인정을 많이 받지 못해도 지금 하는 노력이 반드시 의미 있다는 확신을 가져도 좋다.",
