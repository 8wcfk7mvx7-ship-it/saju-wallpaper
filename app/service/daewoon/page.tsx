...
const UUNSEONG_FORTUNE: Record<string, { label: string; score: number; color: string; desc: string; narrative: string; caution: string; keyword: string; finance: string; career: string; love: string; health: string; todo: string; avoid: string }> = {
  ...
  관대: {
    ...
    desc:"사회에 나가 관복을 처음 입는 시기. 배움과 성장이 폭발적입니다. 이 시기에 쌓은 실력이 이후 최전성기의 토대가 됩니다.",
  ...
  사: {
    ...
    desc:"에너지가 멈춘 시기. 생각은 많고 몸이 움직이지 않습니다. 이 정체의 시간은 사실 다음 단계로 나아가기 위한 충전의 기간입니다.",
  ...
  묘: {
    ...
    desc:"무덤에 갇힌 형국. 활동 반경이 좁고 정신적 답답함이 극에 달합니다. 외부 확장보다 내면 탐구에 집중하는 것이 이 시기를 잘 버티는 방법입니다.",
  ...
  절: {
    ...
    desc:"모든 기반이 끊어지고 리셋되는 시기. 고독과 단절이 운명처럼 찾아옵니다. 불필요한 것들이 청소되고 진짜 자신이 남는 시간입니다.",
  ...
  태: {
    ...
    desc:"새 씨앗이 잉태되는 시기. 아직 세상에 드러나지 않은 가능성의 구간입니다. 지금의 구상과 준비가 이후 성장 대운에서 폭발적인 결실로 이어집니다.",
  ...
  양: {
    ...
    desc:"뱃속에서 무럭무럭 자라는 시기. 조용하지만 착실하게 실력이 쌓입니다. 인정받지 못해도 포기하지 않는 꾸준함이 이 대운의 유일한 전략입니다.",
...
const SIPSEONG_DAEWOON: Record<string, { title: string; color: string; desc: string; life: string; caution: string }> = {
  비견: {
    ...
    desc:"나와 같은 기운이 들어오는 대운. 자존심과 독립심이 강해지고 혼자 해내고자 하는 의지가 커집니다. 경쟁이 많아지는 만큼 관계보다 성과가 중심이 되는 시기입니다.",
    life:"경쟁이 많아지는 시기다. 형제·친구·동료와의 갈등 혹은 연대가 동시에 일어나요. 사업가라면 동업이나 경쟁자 출현, 직장인이라면 같은 라인의 동료들과 경쟁이 심화돼요. 재물을 분산시키는 힘도 있어 재물복보다 관계복이 먼저 와요.",
    caution:"고집과 아집이 강해져 주변과의 마찰이 잦아질 수 있어요. 독불장군 행세를 경계해야 해요."
  },
  겁재: {
    title:"내 것을 빼앗기기 쉬운 대운", color:"#f87171",
    desc:"빼앗는 기운이 강한 대운. 재물이 나갈 일이 생기고 인간관계에서 배신이나 손해가 발생하기 쉽습니다. 반면 잘못된 관계가 강제로 정리되는 효과도 있는 시기입니다.",
  ...
  식신: {
    ...
    desc:"내가 표현하고 먹고 즐기는 기운이 극대화되는 대운. 창의력과 여유가 넘치는 시기입니다. 억지로 애쓰지 않아도 자연스럽게 복이 따라오는 흐름입니다.",
  ...
  상관: {
    ...
    desc:"직장·규범·권위를 흔드는 기운. 기존 질서에 반발하는 시기로, 창의적이지만 파란이 많습니다. 이 에너지를 예술·창작으로 쓰면 탁월한 결과물이 나올 수 있습니다.",
    life:"이 대운은 기존의 질서와 권위에 강하게 반발하는 시기다. 직장을 그만두거나 규칙을 깨뜨리고 싶은 충동이 강해진다. 반면 이 에너지를 예술·창작·혁신 쪽으로 쓰면 탁월한 결과물이 나와요. 언어 능력이 강해져 말이나 글로 인정받기도 하지만, 말 실수나 구설수가 함께 오기도 해요.",
  ...
  편재: {
    ...
    life:"이 시기는 흐르는 돈, 움직이는 재물의 기운이 강하다. 부동산이나 은행 이자 같은 안정된 수입이 아니라 투자·사업·아이디어로 돈을 버는 기운이다. 활발하고 사교적이 되어 이성 관계도 활발해진다. 이 시기에 과감한 투자나 사업 도전이 빛을 발하는 경우가 많다.",
    caution:"들어오는 만큼 나가기도 쉬운 기운이다. 한탕주의적 투기는 금물이며, 들어온 돈을 관리하는 체계가 없으면 흩어진다."
  },
  정재: {
    title:"성실하게 쌓이는 재물의 대운", color:"#f59e0b",
    desc:"성실하게 쌓이는 재물의 대운. 꾸준한 노력이 착실한 자산으로 변환됩니다. 안정적이고 예측 가능한 수입이 이어지며, 절약과 저축이 잘 되는 흐름입니다.",
    life:"이 시기는 월급·이자·임대수입처럼 안정적이고 예측 가능한 재물의 기운이 강하다. 이 대운에는 투기보다 성실한 노동의 대가가 제대로 돌아와요. 절약과 저축이 잘 되고, 재산이 착실하게 불어나는 시기다. 남성이라면 좋은 배우자를 만날 가능성이 높은 대운이기도 하다.",
    caution:"너무 안정 지향적이 되어 큰 도전을 놓칠 수 있어요. 재물에 대한 지나친 집착이 관계를 망치기도 해요."
  },
  편관: {
    title:"강한 압박과 경쟁이 몰려오는 대운", color:"#c084fc",
    desc:"강한 외부 압박과 통제가 들어오는 대운. 극복하면 성공, 못하면 큰 고통입니다. 강한 경쟁 분야에서는 오히려 이 기운이 성공의 발판이 됩니다.",
    life:"이 대운은 사주에서 가장 강렬한 기운 중 하나다. 외부에서 강한 압박·통제·경쟁이 몰려오는 시기로, 이 압력을 견뎌내면 오히려 강해지지만 버티지 못하면 크게 무너진다. 군인·경찰·정치·스포츠처럼 강한 경쟁 분야에서는 오히려 성공하기 좋은 기운이다. 여성이라면 강하고 카리스마 있는 남성과의 인연이 오기도 해요.",
    caution:"무리한 일처리, 사고, 법적 문제가 생기기 쉽다. 스스로를 너무 몰아붙이지 않도록 주의해야 해요."
  },
  정관: {
    title:"명예와 지위가 올라가는 가장 안정된 대운", color:"#a78bfa",
    desc:"사회적 명예와 규범의 대운. 직장·지위·명예가 높아지는 가장 안정된 시기입니다. 사회적 규범을 따르며 자연스럽게 인정받는 흐름이 이어집니다.",
    life:"이 대운은 사주에서 가장 귀하게 여겨지는 흐름 중 하나로 꼽힌다. 사회적 규범을 따르면서 명예와 지위가 자연스럽게 올라가는 시기다. 직장인은 승진, 사업가는 공신력 향상, 학생은 좋은 성적과 진학으로 이어지기 쉽다. 여성이라면 좋은 배우자를 만나거나 결혼이 이루어지는 시기이기도 하다.",
    caution:"명예를 지키기 위해 지나치게 눈치를 보거나 자기 생각을 억누르는 경향이 생길 수 있어요."
  },
  편인: {
    title:"불규칙하고 신비로운 배움의 대운", color:"#94a3b8",
    desc:"불규칙하고 신비로운 배움의 대운. 직관과 영감이 강해지지만 불안정합니다. 철학·예술·종교 등 깊은 분야로 빠져들기 쉬운 시기입니다.",
  ...
  정인: {
    ...
    desc:"배움과 인정의 대운. 안정적인 도움과 지지를 받는 시기입니다. 시험·자격·학업이 잘 풀리고, 스승이나 선배의 도움을 받기 쉬운 흐름입니다.",
    life:"이 대운은 학업·자격증·논문·공부처럼 배움과 관련된 모든 활동이 빛을 발하는 시기다. 어머니나 선배·스승·기관으로부터 도움을 받기 쉽고, 심리적으로 안정감이 있어요. 이 대운에 시험을 보거나 자격을 취득하면 좋은 결과가 나와요. 명예롭고 인정받는 방식으로 살고 싶은 욕구가 강해진다.",
    ...
    <main className="min-h-screen bg-[#06060e] text-white">
      ...
      <div className="max-w-lg mx-auto px-5 py-8 pb-32" id="daewoon-result">
        ...
        <div className="mb-8">
          ...
          {/* 인생 전체 운기 파노라마 */}
          <LifeFortuneChart pillars={daewoon.pillars} currentIdx={daewoon.currentIdx} gender={gender as "male" | "female"} />
