        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center max-w-lg mx-auto w-full px-5 py-16 text-center">
          ...
          <FadeIn delay={300} className="w-full">
            ...
            <button onClick={() => setStep("form")}
              className="w-full py-5 rounded-2xl font-black text-lg tracking-tight bg-gradient-to-r from-rose-600 to-amber-600 hover:from-rose-500 hover:to-amber-500 text-white shadow-lg shadow-rose-900/50 transition-all active:scale-[0.98]">
              내 신년운세 확인하기
            </button>
          </FadeIn>
        </div>
    ...
    return (
      <AnalysisLoading
        ...
        messages={[
          ...
          "필요한 기운과 피해야 할 기운 기준으로 흐름을 정리하는 중...",
        ]}
      />
    );
  }
