...
export default function ChildPage() {
  ...
  if (step === "entry") {
    return (
      <main className="min-h-screen bg-[#070a10] text-white flex flex-col page-fade-in">
        <BackButton />
  ...
  return (
    <main className="min-h-screen bg-[#070a10] text-white">
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-6 pb-16" id="child-result">
        <div className="text-center mb-8">
        ...
        <ResultFooterActions targetId="child-result" fileName="자녀운" />
      </div>
    </main>
  );
}
