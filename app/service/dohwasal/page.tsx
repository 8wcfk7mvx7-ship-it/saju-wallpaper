...
const TYPES: DohwaType[] = [
  ...
  },
  {
    ...
    partner: "이 색기는 본인이 의식하지 않아도 상대에게 강한 신호로 전달되기 때문에, 그 신호를 '존중'으로 받아주는 사람인지가 중요해요. 가벼운 호의를 과도하게 해석하거나, 소유욕을 드러내는 상대는 피하는 게 좋습니다. 반대로, 매력을 매력 그대로 인정하면서도 관계의 선을 지켜주는 사람, 즉 '신뢰'를 기반으로 관계를 만들어가는 사람을 만나면 이 기운이 가장 건강하게 발현됩니다.",
  },
  {
    id: "도화살형",
    emoji: "🌷",
