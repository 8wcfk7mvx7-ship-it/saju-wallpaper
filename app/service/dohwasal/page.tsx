...
const TYPES: DohwaType[] = [
  ...
  },
  {
    ...
    desc: "이성에게 어필하는 매력이 재물운·명예운과 함께 자리한 귀한 구조예요. 일부러 끼를 부리지 않아도 '같이 있으면 든든하고 품격 있는 사람'이라는 인상을 줍니다. 인기와 신뢰를 동시에 가져가는, 흔치 않은 조합이에요.",
...
const CELEB_DB: CelebrityDohwa[] = [
  { name: "설리", tags: ["진도화형", "경국지색도화형"], desc: "도화 기운이 여러 겹으로 겹쳐 쌓인 극강의 구조. 있는 그대로의 모습이 화제가 되고, 의도하지 않아도 시선이 집중되는 타입." },
  { name: "한고은", tags: ["월장도화", "녹방도화형"], desc: "국경과 시대를 넘는 매력. 품위와 인기가 함께 자리한 구조로, 활동할수록 더 깊고 넓은 팬층을 만드는 스타일." },
  { name: "사나", tags: ["월장도화", "경국지색도화형"], desc: "타고난 국제적 도화 기운. 언어와 문화의 장벽 없이 끌림이 전해지는 매력 구조를 갖췄어요." },
  { name: "조이", tags: ["녹방도화형", "도삽도화"], desc: "신뢰감 있고 품격 있는 인기. 화려함보다 '가까워지고 싶다'는 안정적인 끌림을 주는 도화 기운." },
  { name: "초아", tags: ["월장도화", "진도화형"], desc: "도화 기운이 여러 기둥에 걸쳐 자리한 강력한 구조. 만나는 사람마다 강한 인상을 남기는 타입." },
  { name: "구하라", tags: ["도삽도화", "월장도화", "경국지색도화형"], desc: "여러 도화 기운이 동시에 겹쳐 있는 희귀 구조. 어디서든 눈에 띄고, 한번 보면 기억에서 지워지지 않는 매력." },
  { name: "김희선", tags: ["녹방도화형", "경국지색도화형"], desc: "명리학에서 '양귀비 도화'로 불리는 극강의 품격 도화. 아름다움이 신뢰와 인기를 동시에 만들어내는 구조." },
  { name: "송혜교", tags: ["진도화형", "도삽도화"], desc: "친근함과 매력이 공존하는 신뢰감형 도화. 오래 볼수록 더 좋아지는, 시간이 지날수록 깊어지는 인기 구조." },
  { name: "손예진", tags: ["경국지색도화형", "진도화형"], desc: "강렬한 매력살과 도화 기운이 같은 자리에 자리한 강력한 구조. 화면 밖에서도 존재감이 강하게 느껴지는 타입." },
  { name: "제니", tags: ["경국지색도화형", "진도화형"], desc: "강한 매력살과 도화 기운이 겹친 구조. 강렬한 첫인상과 함께 갈수록 더 끌리게 만드는 복합적인 매력." },
  { name: "한가인", tags: ["경국지색도화형"], desc: "전설급 미인 구조로 꼽히는 도화 배열. 의도하지 않아도 분위기 자체가 화제가 되는 타입." },
  { name: "고소영", tags: ["월장도화", "진도화형"], desc: "도화 기운과 강한 에너지가 함께 자리한 구조. 당당하면서도 매력적인, 시대를 초월하는 존재감을 가졌어요." },
  { name: "정윤희", tags: ["진도화형"], desc: "고전적인 미인 구조. 세월이 지나도 흐릿해지지 않는, 뚜렷하고 단단한 도화 기운." },
  { name: "장미희", tags: ["진도화형", "도삽도화"], desc: "한국 미인의 원형으로 자주 언급되는 도화 구조. 신뢰감 있는 끌림이 오랜 시간 팬을 유지시키는 힘." },
  { name: "성유리", tags: ["제왕도화", "도삽도화"], desc: "도화 기운이 가장 강한 위치에 자리한 구조. 첫눈에 시선을 빼앗고, 보면 볼수록 매력이 쌓이는 타입." },
  { name: "유진", tags: ["제왕도화", "도삽도화"], desc: "도화 기운이 가장 강한 자리에 자리한 구조. 화면 속에서도 밖에서도 변하지 않는 안정적인 매력 기운." },
  { name: "쯔위", tags: ["월장도화", "녹방도화형"], desc: "품격과 국제적 인기를 동시에 갖춘 도화 구조. 세련되고 믿음직스러운 끌림이 특징." },
  { name: "G-DRAGON", tags: ["나체도화형", "곤랑도화형"], desc: "직관적이고 강렬한 도화와 갈등 에너지가 함께 자리한 구조. 가만히 있어도 눈길을 끌고, 모든 행동이 화제가 되는 타입." },
  { name: "뷔", tags: ["경국지색도화형", "진도화형"], desc: "여러 기둥에 걸쳐 도화 기운이 겹친 구조. 마주친 사람마다 강한 인상을 남기고, 스쳐 지나가도 기억에 남는 매력." },
  { name: "정국", tags: ["제왕도화", "진도화형"], desc: "도화 기운이 가장 강한 위치에 자리하면서 여러 기둥에 걸쳐 뻗어 있는 구조. 노력과 매력이 함께 상승하는 타입." },
  { name: "송강", tags: ["경국지색도화형", "진도화형"], desc: "강력한 매력살과 도화 기운이 겹친 구조. 화면 속 존재감이 실물보다 더 강하게 느껴지는 드문 케이스." },
  { name: "정형돈", tags: ["월장도화", "경국지색도화형"], desc: "강한 도화 기운이 예능 파급력으로 터진 케이스. 외모와 무관하게 존재 자체가 화제가 되고, 어디서든 중심이 되는 구조." },
  { name: "수진", tags: ["진도화형", "경국지색도화형"], desc: "같은 기운이 두 개의 기둥에 동시에 자리한 매우 강력한 구조. 처음 보는 순간부터 끌리게 만드는 직관적인 매력." },
];
...
export default function DohwasalPage() {
  ...
  if (step === "entry") {
    return (
      <main className="min-h-screen bg-[#150812] text-white flex flex-col page-fade-in">
        <BackButton />
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center max-w-lg mx-auto w-full px-5 py-16 text-center">
          ...
          <FadeIn delay={560}>
            ...
            <button onClick={() => setStep("form")}
              className="w-full py-5 rounded-2xl font-black text-lg tracking-tight bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white shadow-lg shadow-rose-900/50 transition-all active:scale-[0.98]">
              내 도화살 확인하기
            </button>
          </FadeIn>
        </div>
