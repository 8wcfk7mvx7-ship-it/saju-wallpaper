...
const TYPES: DohwaType[] = [
  ...
  },
  {
    ...
    jealousy: "단톡방·모임에서 항상 화두에 오르는 사람. 친한 친구들조차 '쟤 인기는 진짜 어쩔 수 없다'며 인정 반, 부러움 반의 반응을 보입니다.",
...
function pickType(sinsalNames: string[]): DohwaType {
  const priority = ["나체도화형", "곤랑도화형", "녹방도화형", "진도화형", "홍염살형", "도화살형"];
...
export default function DohwasalPage() {
  ...
  const myDohwaList = r.sinsalList.filter(s =>
    ["도화살", "진도화", "나체도화", "곤랑도화", "녹방도화", "홍염살"].includes(s.name)
  );
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-6 pb-16">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black leading-snug">
            {ilgan}{r.pillarsDetail.day.jj}일주, 당신의 도화살은
          </h1>
        </div>
