...
export default function TodayFortunePage() {
      ...
      <main className="min-h-screen bg-[#06060e] text-white flex flex-col page-fade-in">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full px-5 py-16 text-center">
          ...
          <button onClick={() => setStep("form")}
            className="w-full py-4 rounded-2xl font-black text-lg tracking-tight bg-gradient-to-r from-slate-600 to-zinc-600 hover:from-slate-500 hover:to-zinc-500 text-white shadow-lg shadow-black/50 transition-all active:scale-[0.98] flex items-center justify-center leading-none">
            오늘의 운세 확인하기
          </button>
          </FadeIn>
        </div>
  ...
  return (
    <main className="min-h-screen bg-[#06060e] text-white">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 pt-6 pb-16" id="today-result">
        <div className="text-center mb-8">
