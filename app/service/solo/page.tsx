    ...
    <main className="min-h-screen bg-[#0a0612] text-white">
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pt-6 pb-16" id="solo-result">
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-5 mb-5">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            {bigeopCount >= 2 || hasMuGwan
              ...
              : sikSangCount >= 2
              ? "표현력과 생산성을 의미하는 기운이 강합니다. 이 기운은 가정보다 일·창작·콘텐츠 쪽에서 발휘될 때 더 큰 결과로 이어지는 경향이 있어, 비혼 상태에서 자기 일에 몰입할 때 성취도가 높아지는 구조입니다."
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-5 mb-5">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            {hasMuJae
              ? "재물을 의미하는 기운이 약한 구조라, 혼자 경제를 책임져야 하는 비혼 생활에서는 재물 관리가 가장 중요한 변수가 됩니다. 고정 수입을 자동으로 분리·저축하는 시스템을 일찍 만들어두는 것이 노후 안정성에 큰 차이를 만듭니다."
              : hasMuBigeop
              ? "자기 자신의 힘을 의미하는 기운이 약해 혼자 모든 걸 결정하고 책임져야 하는 상황에서 외로움을 크게 느낄 수 있는 구조입니다. 가족 형태의 관계가 아니더라도, 정기적으로 의지할 수 있는 친구·커뮤니티 관계를 의식적으로 만들어두는 것이 정서적 안정에 중요합니다."
