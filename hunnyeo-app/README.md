...
90년대생 추억 뷰티 노트. 17개 장 259개 항목. **무료 · 광고 없음 · 회원가입 없음.**
...
| 화면 | 하는 일 |
|---|---|
| 메뉴판 (`/`) | 17개 장, 오늘의 생정, 아무거나 뽑기, 연속 출석, 방명록 |
| 찾아보기 (`/search`) | 259개 전체 검색(제목·효과·준비물·방법·태그), 찜한 것 모아보기 |
