...
export const CATEGORIES: { key: HunnyeoCategoryKey; label: string; emoji: string; accent: string }[] = [
  { key: "all",      label: "전체",         emoji: "🎀", accent: "#ff6fa5" },
  { key: "skincare", label: "밀가루팩",      emoji: "🍎", accent: "#ff8fb3" },
  { key: "diet",     label: "다이어트",      emoji: "🍉", accent: "#4fb56b" },
  { key: "hair",     label: "헤어관리",      emoji: "💇‍♀️", accent: "#a78bfa" },
  { key: "foot",     label: "발관리",        emoji: "🦶", accent: "#38bdf8" },
  { key: "wannso",   label: "완소템",        emoji: "💗", accent: "#f472b6" },
  { key: "miznet",   label: "미즈넷다이어리", emoji: "💌", accent: "#fbbf24" },
];
...
// ── 완소 도장(좋아요) 로컬 저장 키 ────────────────────────────────────────
export const STAMP_STORAGE_KEY = "hunnyeo_stamps_v1";
