...
export const WEOLJI_PSYCHOLOGY: Record<string, string> = {
  "인": "인월(寅月): 봄 기운 시작. 개척·도전 욕구 강함. 계획하고 돌진하는 선도형. 인정욕구 높음.",
  "묘": "묘월(卯月): 봄의 절정. 유연하고 감수성 풍부. 예술적·섬세함. 타인 시선 예민.",
  "진": "진월(辰月): 봄→여름 전환. 다재다능하나 방향성 혼란. 저장·축적 본능 강함.",
  "사": "사월(巳月): 여름 시작. 탐구·분석·비밀 유지. 내면 복잡, 겉은 차분. 전략적.",
  "오": "오월(午月): 여름 절정. 감정 기복 큼. 직관적·카리스마 있음. 표현 과잉 경향.",
  "미": "미월(未月): 여름→가을 전환. 세심·완벽주의. 뒷처리 잘함. 불안 내재.",
  "신": "신월(申月): 가을 시작. 현실적·냉정. 빠른 판단. 결과 중심. 냉철한 리얼리스트.",
  "유": "유월(酉月): 가을 절정. 완벽주의·심미안. 고집 강함. 독립적이고 날카로움.",
  "술": "술월(戌月): 가을→겨울 전환. 신념 강함. 의리파. 한번 틀어지면 오래감.",
  "해": "해월(亥月): 겨울 시작. 직관·상상력 탁월. 자유로운 영혼. 정착 어려움.",
  "자": "자월(子月): 겨울 절정. 생각 깊음. 비밀 많음. 본능적·감각적. 내면 세계 풍부.",
  "축": "축월(丑月): 겨울→봄 전환. 성실·인내·저축. 느리지만 확실함. 고집스런 완수형.",
};

export const YANG_YIN_TENDENCY = {
  yang: "양간(갑·병·무·경·임): 순행(시계 방향). 이기심에서 출발해 성숙하면 이타적 헌신으로 발전. 외향적·능동적·확장 지향. 직선적 행동.",
  yin: "음간(을·정·기·신·계): 역행(반시계 방향). 혼돈·감각·물질에 먼저 끌림. 내면이 복잡. 성숙하면 정교한 관계망 형성. 직관적·수용적·적응력 높음.",
  yangInLove: "양간 연애: 주도적·정복형. 먼저 들이댐. 단순 명확. 실망하면 빠르게 끊음.",
  yinInLove: "음간 연애: 관찰 후 서서히. 감정이입 깊음. 집착 경향. 이별 후 여운 김.",
};
