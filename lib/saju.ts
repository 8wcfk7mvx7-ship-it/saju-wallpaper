...
export const OHAENG_CORE_WORRY: Record<Element, string> = {
  "목": "목(木) 근원 걱정: '내가 인정받고 있는가' — 존재 가치와 성장에 대한 불안. 칭찬·인정 없으면 뿌리 흔들림.",
  "화": "화(火) 근원 걱정: '내 포지션이 안전한가' — 주목받고 있는가, 빛나고 있는가에 대한 불안. 무시당하면 폭발.",
  "토": "토(土) 근원 걱정: '관계가 안정적인가' — 나를 중심으로 한 인간관계 유지에 대한 불안. 갈등·소외 극도로 두려워함.",
  "금": "금(金) 근원 걱정: '나는 쓸모 있는가' — 사회적 역할·기능에 대한 불안. 쓸모없어지는 것, 버려지는 것이 가장 두려움.",
  "수": "수(水) 근원 걱정: '내가 존재해도 되는가' — 실존적 불안. 의미·방향 없음에 대한 공허. 깊은 철학적 고민 많음.",
};
...
export const SINGANG_RESPONSE_STYLE = {
  신강: {
    core: "외부 의견을 자기 기준으로 걸러냅니다. 타인의 평가나 주류 흐름에 흔들리지 않으며, 자신의 방식을 고수하는 것이 오히려 에너지를 강화합니다.",
    socialStyle: "외부 기대에 맞추려 하면 에너지가 소진됩니다. 자기 기준을 지키는 것이 신강에겐 생존 전략입니다.",
    decisionStyle: "타인의 의견보다 자신의 판단을 우선합니다. 설득보다 원칙이 앞섭니다.",
    caution: "완고함이 관계 마찰을 유발할 수 있습니다. 유연성을 의도적으로 훈련하세요.",
  },
  신약: {
    core: "외부 환경과 타인의 기준에 잘 적응합니다. 유연한 수용력이 강점이며, 주변 흐름을 타고 성장하는 방식이 맞습니다.",
    socialStyle: "타인의 피드백을 수용하고 맞춰가는 것이 신약에겐 현명한 전략입니다. 저항보다 적응에서 기회가 생깁니다.",
    decisionStyle: "외부 의견을 참고해 판단합니다. 혼자 결정하기보다 신뢰하는 사람과 상의하는 것이 유리합니다.",
...
export const HAP_CHUNG_CHARACTER = {
  합: {
    name: "합(合)이 많은 사주",
    core: "에너지의 흐름이 순행합니다. 갈등보다 조화를 추구하고, 부드럽게 흘러가는 성질이 있습니다.",
    strength: "적응력과 포용력이 뛰어납니다. 관계에서 마찰이 적고 분위기를 부드럽게 만드는 능력이 있습니다.",
    weakness: "변화에 저항이 없어 방향성이 흐려질 수 있습니다. 강한 자극이나 도전 없이는 성장 동력이 약해질 수 있습니다.",
    loveStyle: "상대의 변덕을 자연스럽게 받아줍니다. 충이 많은 상대에게는 방향을 잡아주는 역할을 할 수 있습니다.",
    compatible: "충이 많은 상대를 이끌어주고 방향을 제시하는 역할이 맞습니다. 충 상대의 실속 감각을 수용하면 시너지가 납니다.",
  },
  충: {
    name: "충(沖)이 많은 사주",
    core: "에너지가 서로 충돌하며 소용돌이 치는 구조입니다. 한 방향으로 흐르지 않고 내부에서 긴장이 지속됩니다.",
    strength: "현실적 판단력과 영리한 실속 감각이 뛰어납니다. 손익을 빠르게 파악하고 상대가 더 유리한 행동을 하도록 이끄는 능력이 있습니다.",
    weakness: "에너지가 정체되거나 소용돌이쳐 의사결정이 복잡해질 수 있습니다. 감정 기복과 내부 갈등이 잦을 수 있습니다.",
    loveStyle: "강하게 이끌어주는 상대가 필요합니다. 애매하게 배려하는 것보다 명확하게 방향을 제시하고 끌어주는 스타일이 편합니다.",
    compatible: "합이 많은 상대가 방향을 잡아줄 때 안정됩니다. 자신의 실속 감각으로 상대의 부족한 현실 판단을 보완하는 역할을 합니다.",
  },
};
...
export const CHUNGAN_CHUNG_HEALTH: Record<string, { pair: [string, string]; body: string; desc: string }> = {
  갑경충: {
    pair: ["갑","경"],
    body: "두부(頭部)",
    desc: "갑목(甲木)과 경금(庚金)이 충돌합니다. 두통, 편두통, 머리 관련 신경 증상에 주의가 필요합니다. 스트레스가 쌓이면 두통으로 표출되는 경향이 있습니다.",
  },
  을신충: {
    pair: ["을","신"],
    body: "간·신경계",
    desc: "을목(乙木)과 신금(辛金)이 충돌합니다. 간 기능 저하, 신경계 문제, 근육·힘줄 관련 질환에 주의하세요. 과로나 스트레스가 간에 먼저 영향을 미칩니다.",
  },
  병임충: {
    pair: ["병","임"],
    body: "심장·혈관",
    desc: "병화(丙火)와 임수(壬水)가 충돌합니다. 심장 관련 질환, 혈압 문제, 순환계 이상에 주의가 필요합니다. 감정 기복이 심하면 심혈관에 부담이 됩니다.",
  },
  정계충: {
    pair: ["정","계"],
    body: "안구(眼球)·신장",
    desc: "정화(丁火)와 계수(癸水)가 충돌합니다. 안구 질환, 시력 저하, 신장 기능 문제에 주의하세요. 수면 부족이나 과로가 눈과 신장에 가장 먼저 나타납니다.",
  },
};
