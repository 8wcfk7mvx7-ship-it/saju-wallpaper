...
const SINSAL_INFO: Record<string, {hanja:string; category:'lucky'|'unlucky'|'neutral'; desc:string}> = {
  ...
  육해살:   {hanja:"六害殺", category:"unlucky",  desc:"방해·장애가 많고 주변과 마찰이 생기기 쉬워요"},
  // 귀인(吉神)
  ...
  학당귀인: {hanja:"學堂貴人",category:"lucky",   desc:"학습 능력이 뛰어나고 교육·학문에 인연이 깊어요. 지식으로 성공하는 기운이에요"},
...
export const ILGAN_PERSONALITY: Record<string, { short: string; detail: string; keyword: string }> = {
  ...
  경: {
    ...
    keyword: "결단력·직선성·실행력",
    detail: "상남자 기질 투탑 중 하나이에요. 강렬하고 단호하며 직선적이에요. 결단하면 곧바로 실행해요. 감정 표현은 서툴지만 진심이 두텁어요. 미국(경금)처럼 글로벌 표준을 만드는 힘이 있어요.",
  },
  신: {
  ...
  임: {
    ...
    keyword: "진지함·이과형·터프함",
    detail: "명리학적으로 '노인'의 기운이에요. 물상(物象)으로는 밤 — 일요일 저녁의 무드이에요. 바닷물처럼 광대하고 묵직해요. 진지함과 권위의식이 있으며 질서와 위계를 중시해요. 한심한 사람을 가장 싫어하는 일간으로, 타인에게 '이렇게 사는 게 사람이냐'고 꼭꼭 찍는 경향이 있어요. 이번 한번뿐이라는 진지한 마음으로 임하기에 실패하면 완전히 낙담해요. 과학적·이지적이며 논리와 데이터를 우선해요. 감성적 표현과 오글거리는 문구를 불편해해요. 직접적이고 터프한 소통을 선호해요.",
  },
  계: {
    short: "계수(癸水) — 빗물·이슬·안개",
    keyword: "계산적·공상적·실속형",
    detail: "행동보다 계산이 먼저이에요. 옆에서 실속을 챙겨주는 전략가이에요. 표현은 부드럽지만 내면에 '내 말 들어' 기질이 있어요. 공상적인 면과 지적 호기심이 있고 머리가 좋어요. 영국(계수)처럼 냉철한 분석과 합리주의가 강점이에요. 귀여운 면도 있어 주변에 도움이 되는 존재이에요.",
  },
};
...
export const ILJU_60: Record<string, {
  ...
  갑자: { image:"겨울 강가의 큰 나무", uunseong:"목욕", keyword:"총명·학구적·자존심",
    ...
    career:"의료·전문직·IT·교육 분야에 적합해요. 자격증 활용 전문직에서 빛납니다.",
  ...
  갑인: { image:"곧게 뻗은 거대한 나무", uunseong:"건록", keyword:"자립심·리더십·패기",
    ...
    career:"연구직·IT·의료·교육·공학 분야에 적합해요.",
  ...
  갑진: { image:"비옥한 초원에 뿌리내린 큰 나무", uunseong:"쇠", keyword:"책임감·전투력·교육열",
    ...
    career:"의료·부동산·교육 분야에 적합해요. 부동산 투자로 자산을 쌓는 경우도 많어요.",
  ...
  경진: { image:"물이 흐르는 큰 바위산", uunseong:"양", keyword:"독립·지식나눔·괴강",
    ...
    career:"교사·의사·간호사·종교인·약사 분야에 적합해요.",
  ...
  경오: { image:"여름 태양 아래의 바위", uunseong:"목욕", keyword:"활발·매력·강한에너지",
    ...
    career:"영업·마케팅·서비스·스포츠 분야에 적합해요.",
...
export const SIPSEONG_DESC: Record<string, { hanja: string; short: string; detail: string }> = {
  ...
  편관: { hanja: "偏官", short: "추진력·경쟁심·도전",    detail: "강한 추진력과 경쟁심의 기운이에요. 압박 속에서 오히려 빛나고, 도전과 극복에서 성취감을 느껴요." },
  ...
  상관: { hanja: "傷官", short: "표현력·개성·창의성",     detail: "강한 표현력과 개성, 창의성의 기운이에요. 기존 틀을 깨고 독창적인 방식으로 세상과 소통해요." },
  비견: { hanja: "比肩", short: "독립심·자존심·경쟁 관계", detail: "독립심과 자존심이 강한 기운이에요. 내 방식대로 하고 싶고, 경쟁 관계에서 자극을 받아요." },
  겁재: { hanja: "劫財", short: "승부욕·인간관계 변화",   detail: "강한 승부욕과 인간관계 변화의 기운이에요. 재물 경쟁이 따르고 주변 사람이 자주 바뀌는 구조예요." },
  편인: { hanja: "偏印", short: "직관·예술·독특한 통찰",  detail: "독특한 직관과 예술적 감수성의 기운이에요. 정통 방식보다 자기만의 방식으로 깊이 파고드는 에너지예요." },
